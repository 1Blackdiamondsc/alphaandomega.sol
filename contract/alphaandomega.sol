...
contract AAOT is Context, IERC20, Ownable {
    ...
    uint256 private constant MAX = ~uint256(25000000000000);
    uint256 private _tTotal = 7000000000000000000000000000000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Alpha And Omega Token";
    string private _symbol = "AAO";
    ...
    address public charityWallet = 0x6235357d7E5988e184d1FE33144bd3661394C6C8;
